...
const RegisterTemplate: NextPage<RegisterTemplateType> = (props) => {
  const fullName: RH = React.createRef();
  const username: RH = React.createRef();
  const email: RH = React.createRef();
  const password: RH = React.createRef();
      ...
      <div className="container">
        <section className="col mx-auto client-content">
          ...
          <main className="form-signin">
            <form id="ClientLoginForm" onSubmit={(event) => props.register(event, fullName, username, email, password)}>
              ...
              <div className="input-group input-group-lg ltr">
                <TextField name="fullName" placeholder="Your Full name" type="text" ref={fullName} />
              </div>
              <div className="space20"></div>
              <div className="input-group input-group-lg ltr">
                <TextField name="username" placeholder="Your Username" type="text" ref={username} />
              </div>
              <div className="space20"></div>
              <div className="input-group input-group-lg ltr">
                <TextField name="email" placeholder="Your Email" type="email" ref={email} />
              </div>
              <div className="space20"></div>
              <div className="input-group input-group-lg ltr">
                <PasswordField name="password" placeholder="Your Password" ref={password} />
              </div>
