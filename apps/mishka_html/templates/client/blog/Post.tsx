...
const PostTemplate: NextPage<PostTemplateTypes> = ({
  ...
  const metaTags = {
    title: `${post.post_info.title} - MishkaCMS`,
    description: `${post.post_info.meta_description || post.post_info.short_description}`,
    keywords: `${post.post_info.meta_keywords || ''}`,
    url: `http://localhost:3000/blog/${post.post_info.alias_link}`,
    image: `http://localhost:4000/${post.post_info.main_image}`,
  };
