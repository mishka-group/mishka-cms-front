  ...
  return (
    <header id="client-blog-post-main-header">
      <h1 className="post-h1" id="client-blog-post-h1">
        ...
        <span className="post-title">{post.post_info.title}</span>

        <span className="float-end" id="client-blog-post-header-icon">
          ...
          {/* TODO: after changing api Please edit this part */}
          &nbsp;{post.post_info.like_count || 0} &nbsp;
          <svg
