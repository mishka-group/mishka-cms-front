      ...
      <div className="row">
        <article className="col-sm-6 top-home-page-normal-post-article">
          <article className="container-fluid home-image-post rtl client-home-featured-post-article">
            <a href="/blog/subject-58" className="img-fluid client-home-featured-post-image">
              <Image
            ...
            <section className="home-post-like-bookmarks-header-type-banner">
              ...
              <header className="home-blog-posts-normal-with-body-header">
                <h2 className="featured-posts-link">
                  <a href="/blog/subject-58">{posts[0].title}</a>
                </h2>
                <div className="space10"></div>
        ...
        <article className="col-sm-6 top-home-page-normal-post-article">
          <div className="row">
            <article className="col-sm-6 rtl client-home-normal-post-article">
              <a href="/blog/subject-9" className="img-fluid client-home-normal-post-image">
                <Image
              ...
              <section className="home-post-like-bookmarks-header-type">
                ...
                <header className="home-blog-posts-normal-with-body-header">
                  <h2 className="featured-posts-link">
                    <a href="/blog/subject-9">{posts[1].title}</a>
                  </h2>
                </header>
              </section>
            </article>
            ...
            <article className="col-sm-6 rtl client-home-normal-post-article">
              <a href="/blog/subject-3" className="img-fluid client-home-normal-post-image">
                <Image
              ...
              <section className="home-post-like-bookmarks-header-type">
                ...
                <header className="home-blog-posts-normal-with-body-header">
                  <h2 className="featured-posts-link">
                    <a href="/blog/subject-3">{posts[2].title}</a>
                  </h2>
                </header>
              </section>
            </article>
          ...
          <div className="row">
            <article className="col-sm-6  rtl client-home-normal-post-article">
              <a href="/blog/subject-43" className="img-fluid client-home-normal-post-image">
                <Image
              ...
              <section className="home-post-like-bookmarks-header-type">
                ...
                <header className="home-blog-posts-normal-with-body-header">
                  <h2 className="featured-posts-link">
                    <a href="/blog/subject-43">{posts[4].title}</a>
                  </h2>
                </header>
              </section>
            </article>
            ...
            <article className="col-sm-6  rtl client-home-normal-post-article">
              <a href="/blog/subject-31" className="img-fluid client-home-normal-post-image">
                <Image
              ...
              <section className="home-post-like-bookmarks-header-type">
                ...
                <header className="home-blog-posts-normal-with-body-header">
                  <h2 className="featured-posts-link">
                    <a href="/blog/subject-31">{posts[4].title}</a>
                  </h2>
                </header>
              </section>
            </article>
